                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <a href="product.php?search=Chocolate">
                                        <img src="https://via.placeholder.com/250x100?text=Quảng+Cáo+Chocolate" class="d-block w-100" alt="Quảng cáo Chocolate">
                                    </a>
                                </div>
                                <div class="carousel-item">
                                    <a href="product.php?search=Bánh">
                                        <img src="https://via.placeholder.com/250x100?text=Quảng+Cáo+Bánh" class="d-block w-100" alt="Quảng cáo Bánh">
                                    </a>
                                </div>
                                <div class="carousel-item">
                                    <a href="cart.php">
                                        <img src="https://via.placeholder.com/250x100?text=Ưu+Đãi+Giỏ+Hàng" class="d-block w-100" alt="Ưu đãi Giỏ hàng">
                                    </a>
                                </div>
                            </div>
